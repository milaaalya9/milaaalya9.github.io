...
<div class="section-porto">
	...
	<h3>Need of electricity and water is increasing day by day, but it is not followed by the increasing of their availability.</h3>
	<p>For the last decade (2003-2013), the level of energy consumption in Indonesia has been going through an increase. The number rises from 79 tonnes of oil equivalent (TOE) to 134 TOE, equivalent to an average of 5,5% increase per year. The consequences of it might be electricity and water crisis that will be bad as energies are an essential need in the life of the current generation. </p>	
</div>

<div class="section-porto">
	<p class="section-subheader">Define direction based on user problems</p>
	<h3>To solve the issue we are  targeting people who has control over their energy bills and usages</h3>
	...
	<img src="/assets/image/porto/aktro-1.png" class="img-follow">
</div>

<div class="section-porto">
	<p class="section-subheader">Define other stakeholders </p>
	<h3>We believed to build an application for mass benefits we needs to map suitable stakeholders to collaborate and support the product</h3>
	...
	<li>PDAM as one of water supplier in Indonesia, own by the government</li>
...
<div class="section-porto">
	...
	<h3>Designing solutions to address needs and formulating monetisation models</h3>
	<b>How might we encourage users to reduce their consumption?</b>
		<li>Enable user to see their energy consumptions information both for water and electricity  in real time to give them awareness when increased usage occurs.</li>
		<li>Enable users to compare their electricity and water bills to know one of their usage consequences</li>
		<li>Motivare users whose succed to decrease their consumption with reward. For each decrease in water or electricity usage, the user will gain points. The accumulated points can then be exchanged for various rewards in forms of vouchers or gifts.</li>
		<li>Periodically inform users on the risk of wasting energy for environment</li>
	<b>How might we help users manage their energy consumption?</b>
		...
		<li>Enable user to set limit and target of their consumptions, so they know what to achive</li>
	...
	<b>How might we monetize the apps?</b>
		<p>We think of partnering with stakeholders that we stated previously. The rewards system and cost might be come from the government funds. </p>
	<b>System design</b>
	<br>
	We talked with PLN representative to understand feasibility of system and created the diagram below.
	<img src="/assets/image/porto/aktro-2.png" style="width: 80%">
</div>
<div class="section-porto">
	<h3>The design</h3>
	<p>You can interect with the prototype below. It's in Indonesia language.</p>
...
<div class="section-porto">
	...
	<h3>Designing products for public and non-commercial intention needs a lot of iteartions</h3>
	<p>I learn that designing products for people goods needs a lot of aspects to think about. I believe the design needs further iterations, it can be a pilot testing or research with a broad participants. We still have bunch of questions without answers.</p>
</div>
